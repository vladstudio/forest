...
| `branchPrefix` | no       | —                     | Literal prefix prepended to the pre-filled branch name when creating a new tree (e.g. `"vlad/"`). Editable in the input, so it can be removed for one-offs.                                                                                                                                                                          |
